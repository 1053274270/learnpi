...
class Tanke(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.img=pygame.image.load('images\\tanke.png')    
...
class Zhuan(pygame.sprite.Sprite):
    def __init__(self,p):
        pygame.sprite.Sprite.__init__(self)
        self.img=pygame.image.load('images\\zhuan.png')    
        self.rect=self.img.get_rect()
        self.rect.topleft=p   
class Q_buttle(pygame.sprite.Sprite):
    def __init__(self,pos):
        pygame.sprite.Sprite.__init__(self)
        self.img=pygame.image.load('images\\zidan1.png')
        self.rect=self.img.get_rect()
...
pygame.display.set_caption("喵喵喵？")
size=[1600,900]
