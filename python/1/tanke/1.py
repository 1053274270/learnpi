...
texta=pygame.image.load('images//zhizhen.png')#.convert_alpha()
screen=pygame.display.set_mode((800,700),0,32)
missile=pygame.image.load('images//tanke.png').convert_alpha()
...
while True:
    ...
    missiled=pygame.transform.rotate(missile,-(fangle+90))
    if 0<-fangle<90:
    ...
    print(fangle)
    screen.blit(texta, (x2,y2)) #鼠标用一个红色*代替
