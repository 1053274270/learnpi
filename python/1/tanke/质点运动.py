...
missile=pygame.image.load('images\\zidan1.png').convert_alpha()
...
while True:
    for event in pygame.event.get():
        if event.type==pygame.QUIT:
            sys.exit()
    clock.tick(300)
    x,y=(100,100) #pygame.mouse.get_pos()          #获取鼠标位置，鼠标就是需要打击的目标
    ...
    screen.blit(missile, (x1-missile.get_width()/2,y1-missile.get_height()/2))
